create or replace PROCEDURE Modify_No_Places_4(trip_id INT, no_places INT) AS
tmp_reserv0 INT;
reserved_places INT;
...
BEGIN
 ...
 END IF;
  ...
  SELECT 1 INTO tmp_reserv0 FROM trip t WHERE t.trip_id  = Modify_No_Places_4.trip_id;
  -- wydobycie ilosci dostepnych miejsc
  SELECT uptr.NO_PLACES - uptr.NO_AVAILABLE_PLACES,
          uptr.NO_AVAILABLE_PLACES - uptr.NO_PLACES + Modify_No_Places_4.no_places
         INTO reserved_places,new_available_place FROM UPCOMING_TRIPS_4 uptr WHERE uptr.TRIP_ID = Modify_No_Places_4.trip_id;
  ...
  UPDATE TRIP t SET
    t.MAX_NO_PLACES = Modify_No_Places_4.no_places,t.NO_AVAILABLE_PLACES = Modify_No_Places_4.new_available_place
