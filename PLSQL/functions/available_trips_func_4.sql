...
create or replace type available_trips_table_4 is table of available_trips4;

create or replace function available_Trips_Func_4(country_name varchar, date_from DATE, date_to DATE)
...
AND avt.trip_date BETWEEN available_Trips_Func_4.date_from AND available_Trips_Func_4.date_to;
